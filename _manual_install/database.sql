...
(2, 0, 'Travel', 'travel', 'Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliquaUt enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliq', '', 'Y'),
(3, 0, 'Tekno', 'tekno', 'Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliquaUt enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliq', '', 'Y'),
(4, 0, 'Sport', 'sport', 'Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliquaUt enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliq', '', 'Y');
...
CREATE TABLE `t_roles` (
  ...
  `modify_access` int(1) NOT NULL DEFAULT 0,
  `delete_access` int(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
...
(1, 'general', 'web_name', 'CiFireCMS', 'text', ''),(2, 'general', 'web_url', 'http://localhost/cifirecms/', 'text', ''),
(3, 'general', 'web_description', 'Indonesian free CMS and great Community support.', 'other', ''),
(4, 'general', 'web_keyword', 'CifireCMS, CMS Codeigniter, CMS Indonesia, CMS Open Source', 'text', ''),
(5, 'general', 'web_author', 'CiFireCMS', 'text', ''),
(6, 'general', 'web_email', 'site@email.here', 'text', ''),
(7, 'general', 'telephone', '0123456789', 'text', ''),
(8, 'general', 'fax', '000-0000-0000', 'text', ''),
(9, 'general', 'address', 'Manado Sulawesi Utara, Indonesia', 'other', ''),
(10, 'general', 'map_latitude', '1.483764', 'text', ''),
(11, 'general', 'map_longitude', '124.833402', 'text', ''),
(12, 'image', 'favicon', 'favicon/favicon.png', 'file', ''),
(13, 'image', 'web_logo', 'favicon/logo.png', 'file', ''),
(14, 'image', 'web_image', 'favicon/web-image.png', 'file', ''),
(15, 'local', 'timezone', 'Asia/Jakarta', 'timezone', ''),
(16, 'local', 'country', 'Indonesia', 'text', ''),
(17, 'mail', 'mail_protocol', 'smtp', 'select', 'smtp|sendmail|mail'),
(18, 'mail', 'mail_hostname', '', 'text', ''),
(19, 'mail', 'mail_username', '', 'text', ''),
(20, 'mail', 'mail_password', '', 'password', ''),
(21, 'mail', 'mail_port', '465', 'text', ''),
(22, 'config', 'maintenance_mode', 'N', 'select', 'N|Y'),
(23, 'config', 'member_registration', 'Y', 'select', 'N|Y'),
...
(32, 'other', 'web_analytics', 'Y', 'select', 'Y|N'),
(33, 'other', 'google_analytics', 'google analytics code', 'text', ''),
...
CREATE TABLE `t_user` (
  `id` int(100) NOT NULL AUTO_INCREMENT,
  `key_group` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
(1, 'root', 'administrator', 'c4fb75569a0497ea2b150b1fe9566773742e08eb4206f11ffd9914363d63da49af55eee0e44bd6aa774184ccc6892db3ed167b8d7b223282ff88df8c316af83d1TjkspOBVwcs0J5zT2qtaSQ1JGu5Ja92q/rWfu1EU1E=', 'your@email.here', 'Administrator', 'M', '2019-12-12', 'Lorem ipsum dolor sit amet consectetur adipiscing elit fusce eget turpis pulvinar interdum tellus blandit imperdiet velit.', 'Lorem ipsum dolor sit amet consectetur adipiscing elit fusce eget turpis pulvinar interdum tellus blandit imperdiet velit.', '08123456789', 'user-9d3497c8dba97f10d347d9cbb96fc4d2.jpg', 'Y', '0', '0'),
