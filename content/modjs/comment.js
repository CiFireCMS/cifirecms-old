			...
			$('.modal_detail').click(function() {
				...
				$.ajax({
					...
					success: function(data){
						$('#cdet').html('<div><b>' + data.name + '</b>&nbsp;<small class="text-muted">(' + data.email + ')</small></div><div style="margin-bottom:18px;font-size:14px;color:#888;"><small>' + data.date + '</small></div><div><p>' + data.comment + '</p></div>'+data.link);
