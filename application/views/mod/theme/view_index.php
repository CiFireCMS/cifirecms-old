					...
					<div class="card">
						<div class="card-body text-center">
							...
							<div class="btn-group">
								...
								<button class="btn btn-xs btn-white backup_theme" data-toggle="tooltip" data-title="<?=lang_line('button_backup');?>" data-theme-id="<?=encrypt($res['id']);?>" data-theme-folder="<?=encrypt($res['folder']);?>" data-theme-title="<?=encrypt($res['title']);?>"><i class="cificon licon-download"></i></button>
