			...
			<div class="row">
				...
				<div class="col-md-3">
					...
					<div class="form-group">
						...
						<a href="javascript:void(0)" id="delpict" class="btn btn-xs btn-white pull-right"><i class="icon-bin"></i> <?=lang_line('button_delete');?></a>
						<div>
							<a class="browse-files" href="<?=content_url('plugins/filemanager/dialog.php?type=1&relative_url=1&field_id=picture&sort_by=date&descending=1');?>">
								<img id="imgprv" class="img-thumbnail" src="<?=post_images($result_post['post_picture'],'',TRUE);?>" style="width:100%;">
							</a>
