<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
		...
		<footer class="footer">
			...
			<div class="allright">
				<p>Copyright <?php echo date('Y'); ?> <a href="<?php echo site_url(); ?>" title="<?php echo $this->settings->website('web_name') ?>"><?php echo $this->settings->website('web_name') ?></a>. Powered By <a href="https://www.cifirecms.alweak.com/" title="Alweak CiFireCMS">CiFireCMS</a></p>
			</div>
		</footer>
	</div>
