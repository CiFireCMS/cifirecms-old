...
class MY_Controller extends CI_Controller {
	...
	{
		$this->meta_title = !is_null($param) ? $param : get_setting('web_name');
		return $this;
	}
	...
	{
		$this->meta_keywords = !is_null($param) ? $param : get_setting('web_keyword');
		return $this;
	}
	...
	{
		$this->meta_description = !is_null($param) ? $param : get_setting('web_description');
		return $this;
	}
	...
	{
		$this->meta_image = !is_null($param) ? $param : favicon('web_image');
		return $this;
	}
